...
/* Reg Select Port */
#define     LCD_DIR_RS        P4DIR
#define     LCD_OUT_RS        P4OUT

/* Read/Write Port */
#define     LCD_DIR_RW        P4DIR
#define     LCD_OUT_RW        P4OUT

/* Enable Port */
#define     LCD_DIR_EN        P4DIR
#define     LCD_OUT_EN        P4OUT
...
#define     LCD_PIN_RW        BIT5
#define     LCD_PIN_EN        BIT6
